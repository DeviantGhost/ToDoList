...
class SignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    var usersDataSource: [UserSignUp]?
    ...
    var signUpButtonsHeight = 50.0
    var signUpButtonsWidth = 280.0
    ...
    func getButtonAttributes(Label: String) -> UIButton{
        ...
        button.layer.cornerRadius = signUpButtonsHeight/2
    ...
    func getTxtField(placeHolder: String) -> UITextField{
        ...
        txt.layer.cornerRadius = signUpButtonsHeight/2
    ...
    func setUpConstraints(){
        ...
        //Login Constraints
        constraintHeight = NSLayoutConstraint.init(item: signUpButton!, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: signUpButtonsHeight)
        view.addConstraint(constraintHeight)
        
        var constraintWidth = NSLayoutConstraint.init(item: signUpButton!, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .width, multiplier: 1.0, constant: signUpButtonsWidth)
        ...
        constraintTop = NSLayoutConstraint.init(item: signUpButton!, attribute: .top, relatedBy: .equal, toItem: password!, attribute: .bottom, multiplier: 1.0, constant: 20)
        view.addConstraint(constraintTop)
        
        //Facebook Constraints
        constraintHeight = NSLayoutConstraint.init(item: facebookButton!, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: signUpButtonsHeight)
        view.addConstraint(constraintHeight)
        
        constraintWidth = NSLayoutConstraint.init(item: facebookButton!, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .width, multiplier: 1.0, constant: signUpButtonsWidth)
        view.addConstraint(constraintWidth)
        ...
        constraintTop = NSLayoutConstraint.init(item: facebookButton!, attribute: .top, relatedBy: .equal, toItem: signUpButton!, attribute: .bottom, multiplier: 1.0, constant: 20)
        view.addConstraint(constraintTop)
    ...
    @objc func signUpClicked(){
        ...
        if firstName?.text?.count == 0 ||  lastName?.text?.count == 0 || email?.text?.count == 0 || password?.text?.count == 0{
            //show error alert
            return
        }else{
            ...
            usersDataSource?.append(newUser)
        }
    }
